...
public class GPSR_FindOnePath_RNG implements AlgorFunc {
	...
	public GPSR_FindOnePath_RNG(Algorithm algorithm){
	...
	public boolean findOnePath(boolean needPainting){
		...
		// get GG graph
		GPSR_Planarization_RNGWithUnavailable func_planarization_RNGGWithUnavailable = (GPSR_Planarization_RNGWithUnavailable)getAlgorithm().getFunctions()[9];
		func_planarization_RNGGWithUnavailable.Planarization("RNG", false);
