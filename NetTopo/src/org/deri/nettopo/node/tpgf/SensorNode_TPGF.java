package org.deri.nettopo.node.tpgf;
...
public class SensorNode_TPGF extends SensorNode {
	private int expectedLifeTime;
	private int minRate;
	private ArrayList<Integer> neighbors; // store all neighbors' id
	private ArrayList<Integer> MPRs;//store all MPRs' id
	private String[] extraAttrNames ;
	
	public SensorNode_TPGF(){
		super();
		expectedLifeTime = 1;
		minRate = 1;
